...
pygame.display.set_caption("Balanced Card Game | Lizard Spock")
...
def main():
    ...
    while running:
        ...
        display_text("Lizard Spock game", WHITE, 150, 50)
        display_text("Choose: Rock, Paper, Scissors, Lizard, Spock", WHITE, 150, 90)
