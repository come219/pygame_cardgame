...
pygame.display.set_caption("Balanced Card Game")
...
# Load images
game_img = pygame.image.load("assets/help_extended.png")
...
def main():
    ...
    while running:
        ...
        display_text("Ladder Level 3: Extended Girl", WHITE, WIDTH - 800, 4)
        display_text('"I heard you like Rock, Paper, Scissors...', WHITE, WIDTH - 800, 50)
        display_text("Heard of  its extended game? Lets go 1.", WHITE,  WIDTH - 800, 90)
        display_text("Choose wisely ...", WHITE,  WIDTH - 800, 130)
        display_text("Rock, Paper, Scissors, Human, Snake,", WHITE,  WIDTH - 800, 180)
        display_text("Tree, Air, Fire, Water, Lightning,", WHITE,  WIDTH - 800, 230)
        display_text('Gun, Devil, Dragon, Wolf, Sponge"', WHITE,  WIDTH - 800, 280)
